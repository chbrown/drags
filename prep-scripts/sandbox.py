...
left   = '../../project/recordings/male_female/magenta_m.wav'
right  = '../../project/recordings/male_female/magenta_f.wav'
output = '/Users/chbrown/Desktop/magenta_m-l+magenta_f-r.wav'
align_waves(left, right, output, show_graphs=True)
